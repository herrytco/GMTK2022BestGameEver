namespace Interfaces
{
    public interface ITileEffect
    {
        ...
        public bool OnOccupied(ITile tile, ICharacter visitor)
        {
            return true;
        }
        ...
        public bool OnLeave(ITile tile, ICharacter visitor, ITile destination)
        {
            return true;
        }
        ...
        /// </summary>
        /// <returns>True if nothing happens to the character and remaining effects should be applied.</returns>
        public bool OnCharacterVisit(ITile tile, ICharacter visitor)
        {
            return true;
        }
    }
